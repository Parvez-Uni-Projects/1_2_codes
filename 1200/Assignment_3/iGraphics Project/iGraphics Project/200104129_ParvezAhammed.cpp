...
int score = 0;
int green_ballon_point = 20;
int red_ballon_point = 10;
...
void iDraw()
{
	...
	iShowImage(40,40,40,40,play_button);

	if(a==1){
		
		iShowImage(225, pic_green_ballon_y, 100, 100, green_ballon);
	}

	if(a==2)
	{
		iShowImage(325, pic_red_ballon_y, 100, 100, red_ballon);
	}


    if(a == 1)
	{
		iShowImage(325, pic_red_ballon_y, 100, 100, boom_image);
		iShowImage(325, pic_red_ballon_y, 100, 100, boom_image);
		iShowImage(325, pic_red_ballon_y, 100, 100, boom_image);
		iShowImage(325, pic_red_ballon_y, 100, 100, boom_image);
		iShowImage(325, pic_red_ballon_y, 100, 100, boom_image);
	...
	if(a == 2)
	{
		...
		iShowImage(225, pic_green_ballon_y, 100, 100, boom_image);
		iShowImage(225, pic_green_ballon_y, 100, 100, boom_image);
		iShowImage(225, pic_green_ballon_y, 100, 100, boom_image);
		iShowImage(225, pic_green_ballon_y, 100, 100, boom_image);
		iShowImage(225, pic_green_ballon_y, 100, 100, boom_image);
...
void iMouse(int button, int state, int mx, int my)
{
	if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN)
	{
		if(mx >= 225 && mx <= 325)
		{
			//printf("%d\n%d\n",my,pic_green_ballon_y);
			if(my >= pic_green_ballon_y && my <= pic_green_ballon_y+80)
			{
				a=2;
		...
		{
			//printf("%d\n%d\n",my,pic_green_ballon_y);
			if(my >= pic_red_ballon_y && my <= pic_red_ballon_y+80)
			{
				a=1;
...
int main()
{
	...
	play_button= iLoadImage ("images\\boom.png");
